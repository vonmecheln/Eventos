<?php
/**
 * @abstract Plugin para formatar o endereço para o Pagseguro
 * referentes ao campo endereço / numero
 * 
...
class Plugin_DesformataEndereco extends Sistema_Plugin{
	...
	/**
	 * @abstract Método para formatar os dados para retorno no input
	 * @param string $valor Valor a ser retornoado
	 * @param string $tipo Tipo do campo que deverá ser retornado
