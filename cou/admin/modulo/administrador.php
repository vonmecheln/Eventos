<?php
/**
 * @abstract Mѓdulo referente as aчѕes do desenvolvimento do sistema
 * 
 * @copyright  -
 * @version    1.0
 * @author     Alexandre
...
class Modulo_Administrador extends Sistema_Modulo{
	...
	/**
	 * Aчуo responsсvel pela criaчуo do formulсrio
	 * para cadastros dos Mѓdulos
	 * @return Form
	 */
	public function acaoFormModulo(){
		...
		$this->_layout->setBotoes("Novo Mѓdulo",Sistema_Util::getURL($this->_modulo,"formmodulo"),"imagens/form.png");
		$this->_layout->setBotoes("Listar Mѓdulo",Sistema_Util::getURL($this->_modulo,"listarmodulo"),"imagens/list.png");
		$this->_layout->setNomePagina($this->_leng['formmodulo']);
		$this->_layout->setCorpo($form->getForm($this->_modulo,"salvarmodulo"));
	}

	/**
	 * Aчуo responsсvel pela criaчуo da listagem
	 * dos Mѓdulos
	 * @return Listagem
	 */
	public function acaoListarModulo(){
		...
		$lista->setSQL($sql);
		$lista->setColuna("mdl_cod","Cѓdigo","5%");
	...
	/**
	 * Aчуo responsсvel para salvar os dados vindos
	 * do formulсrio
	 * @return JSON
	 */
	...
	public function acaoFormAcao(){
		...
		$this->_layout->setBotoes("Nova Aчуo",Sistema_Util::getURL($this->_modulo,"formacao"),"imagens/form.png");
		$this->_layout->setBotoes("Listar Aчѕes",Sistema_Util::getURL($this->_modulo,"listaracao"),"imagens/list.png");		
		
		$this->_layout->setNomePagina("Cadastrar Aчѕes");
	...
	public function acaoListarAcao(){
		...
		$lista->setSQL($sql);
		$lista->setColuna("acao_cod","Cѓdigo","5%");
		$lista->setColuna("acao_nome","Nome");
		$lista->setColuna("acao_titulo","Titulo");
		$lista->setColuna("mdl_titulo","Mѓdulo");
		...
		$this->_layout->setBotoes("Nova Aчуo",Sistema_Util::getURL($this->_modulo,"formacao"),"imagens/form.png");
		$this->_layout->setNomePagina("Listar Aчѕes");
		$this->_layout->setCorpo($lista->getForm());
	}	
	...
	public function acaoListarMenu(){
		...
		$lista->setSQL($sql);
		$lista->setColuna("mnu_cod","Cѓdigo","5%");
