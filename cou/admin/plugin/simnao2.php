...
class Plugin_Simnao2 extends Sistema_Plugin 
{
    ...
    {    	
		if (($valor=="sim") || ($valor =="não") || ($valor == 't') || ($valor == true ) || ($valor == 'f') || ($valor == false)) {
			return true;
		} else {
    ...
    public function formataExibicao($valor)
    {
        ...
        if (($valor == 'f') || ($valor == 'não') || ($valor=='false')) {
            return 'não';
        }
    }    
	 ...
	 *
	 * Recebe como parâmetro o nome do campo que será utilizado nos parâmetros
	 * name e id
	 * 
