 ...
 ***********************************************************/
 /*
	define('SISTEMA_DIR', 'C:\xampplite\htdocs\evento\admin\\');
    define('SISTEMA_URL', 'http://localhost/evento/admin/');
	define('UPLOAD_DIR', SISTEMA_DIR.'..\trabalhos\files\\');
	define('COMPROVANTE_DIR', SISTEMA_DIR.'..\trabalhos\comprovantes\\');

    define('SISTEMA_INDEX', 'http://localhost/evento/admin/index.php'); 
	define('SISTEMA_SITE', 'http://127.0.0.1/evento/');       
    */
	
    define('SISTEMA_DIR', 'C:/Arquivos de programas/Apache Software Foundation/Apache2.2/htdocs/evento/admin/');
    define('SISTEMA_URL', 'http://localhost/evento/admin/');	    
    define('SISTEMA_INDEX', 'http://localhost/evento/index.php'); 	
