...
class Classe_Trabalho extends Sistema_Persistencia {
	...
	protected $_campos = array(
		"trb_cod"=>array("Cуdigo","incremento"),
		"usr_cod"=>array("Particpante","participante",true),
		"trb_titulo"=>array("Tнtulo","texto",255,true),
		...
		"trb_area"=>array("Бrea","texto",255),
		"trb_areabasica"=>array("Бrea Bбsica","texto",255),
		...
		"trb_referencia1"=>array("Referкncia 1","texto",500,true),
		"trb_referencia2"=>array("Referкncia 2","texto",500,true),
		"trb_referencia3"=>array("Referкncia  3","texto",500),
		"trb_palavraschave"=>array("Palavras Chaves","texto",255,true),
		"trb_frmapresentacao"=>array("Forma de Apresentaзгo","texto",255,true),
		"trb_observacao"=>array("Observaзгo","textarea",255,false),
